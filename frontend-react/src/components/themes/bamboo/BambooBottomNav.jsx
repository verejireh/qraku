...
export default function BambooBottomNav() {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 h-20 bg-[#f8f8f5]/85 backdrop-blur-xl border-t border-[#7f8000]/20 flex justify-around items-center px-4 z-[60] pb-2">
            {navItems.map((item) => {
                ...
                return (
                    <button
                        ...
                        className={`flex flex-col items-center gap-1 transition-colors ${isActive ? 'text-[#7f8000]' : 'text-slate-400 hover:text-[#7f8000]'}`}
                    >
