...
export default function SakuraBottomNav() {
    ...
    return (
        <nav
            className="fixed bottom-0 left-0 w-full h-20 flex items-center justify-around border-t border-[#ffb8c6]/20 z-40 px-2 font-display"
            ...
            {navItems.map((item) => {
                ...
                return (
                    <button
                        ...
                        className={`flex flex-col items-center gap-1 transition-colors ${isActive ? 'text-[#ffb8c6]' : 'text-slate-400 hover:text-[#ffb8c6]'}`}
                    >
