...
export default function CosmosThemeView({
    storeId,
    tableNumber,
    activeCategory,
    setActiveCategory,
    ...
    return (
        <div className="relative min-h-screen bg-[var(--background-light)] text-slate-900 font-display overflow-x-hidden pb-48">
            {/* Pattern Overlay */}
            <div className="fixed inset-0 cosmos-bg pointer-events-none z-0"></div>
            ...
            <div className="theme-layout relative z-10">
                <div className="cat-sidebar sticky top-[64px] z-40 bg-white/90 backdrop-blur-md py-3">
                                                ...
                                                >
                                                    ...
                                                    <div className="p-4">
                                                        ...
                                                        <p className="text-slate-500 text-xs mb-4 leading-relaxed line-clamp-2">
                                                            {getMenuDescription(item) || "Experience the unique style of Cosmos."}
                                                        </p>
                                                        <button
