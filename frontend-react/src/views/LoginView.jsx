            ...
            <div className="relative z-10 w-full max-w-sm space-y-10">
                ...
                <header className="text-center space-y-4">
                    ...
                    <div className="space-y-1">
                        <h1 className="text-3xl font-bold text-white tracking-tight">QRaku ログイン</h1>
                        <p className="text-slate-500 text-xs">オーナー管理画面へアクセス</p>
                    </div>
                </header>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">初めての方は</span>
                    <div className="flex-1 h-px bg-white/10" />
                </div>
