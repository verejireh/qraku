...
from routers import (
    ...
    beta, ws_token, seo, insights, referrals, leads, line_bot, room_service
)
...
api_router.include_router(square_oauth.router)
api_router.include_router(line_bot.router)
api_router.include_router(ws_token.router)
api_router.include_router(insights.router)
api_router.include_router(referrals.router)
api_router.include_router(leads.router)
api_router.include_router(room_service.router)
