...
export default function CosmosBottomNav() {
    ...
    return (
        <nav className="fixed bottom-0 inset-x-0 bg-white/75 backdrop-blur-xl border-t border-[#e13370]/10 flex items-center justify-between px-4 py-2.5 z-[110]">
            {navItems.map((item) => {
                ...
                return (
                    <button
                        ...
                        className={`flex flex-col items-center gap-1 flex-1 transition-colors ${isActive ? 'text-[#e13370]' : 'text-slate-400 hover:text-[#e13370]'}`}
                    >
