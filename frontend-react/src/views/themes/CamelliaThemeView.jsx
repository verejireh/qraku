...
export default function CamelliaThemeView({
    ...
    return (
        <div className="relative min-h-screen bg-[var(--background-light)] text-slate-900 font-display overflow-x-hidden pb-48">
            {/* Pattern Overlay */}
            <div className="fixed inset-0 camellia-pattern pointer-events-none z-0"></div>
            ...
            <div className="theme-layout relative z-10">
                <div className="cat-sidebar sticky top-[64px] z-40 bg-[#1a0608]/90 backdrop-blur-md py-3">
