...
| **S4** | LINE 봇 위치추천 | QRaku 공식 LINE에서 위치 전송→근처 TOP3 카드 회신 | 손님: "앱 안 열고 LINE 안에서 3초 만에 탐색" |
...
| 2026-06-08 | S4 LINE 봇 | ⏸ 보류 — 플랫폼 LINE 공식계정/Messaging API 채널(Channel Access Token+Secret) 외부 선행 필요. 대표님 채널 생성 후 진행 결정. |
